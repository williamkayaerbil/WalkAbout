...
<div class="row">
	<div class="col-md-12 filters">
		<form class="" role="form" method="GET">
			...
			<div class="form-group col-md-2">
				<label class="" for="filter[map_id]" >Map</label>
				<div class="">
					{{Form::select('filter[map_id]', $maps, Input::get('filter')['map_id'],array('class'=>'form-control'))}}
				</div>
			</div>
...
@section('modal-import')
 	<form enctype="multipart/form-data" action="{{url('admin/layers/import')}}" method="POST">
